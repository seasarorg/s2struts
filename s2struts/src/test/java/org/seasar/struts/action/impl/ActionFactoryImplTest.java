...
public class ActionFactoryImplTest extends S2TestCase {
    ...
    public void testGetActionWithClassName() {
        ...
        firstInstance = actionFactory.getActionWithClassName("org.seasar.struts.action.impl.Test1Action", servlet);
        secondInstance = actionFactory.getActionWithClassName("org.seasar.struts.action.impl.Test1Action", servlet);
        assertTest1Action(firstInstance, secondInstance);

        firstInstance = actionFactory.getActionWithClassName("org.seasar.struts.action.impl.Test2Action", servlet);
        secondInstance = actionFactory.getActionWithClassName("org.seasar.struts.action.impl.Test2Action", servlet);
        assertTest2Action(firstInstance, secondInstance);

        firstInstance = actionFactory.getActionWithClassName("org.seasar.struts.action.impl.Test3Action", servlet);
        secondInstance = actionFactory.getActionWithClassName("org.seasar.struts.action.impl.Test3Action", servlet);
    ...
    private void assertTest1Action(Action firstInstance, Action secondInstance) {
        ...
        assertTrue(firstInstance instanceof org.seasar.struts.action.impl.Test1Action);
    ...
    private void assertTest2Action(Action firstInstance, Action secondInstance) {
        ...
        assertTrue(firstInstance instanceof org.seasar.struts.action.impl.Test2Action);
    ...
    private void assertTest3Action(Action firstInstance, Action secondInstance) {
        assertSame(firstInstance, secondInstance);
        assertTrue(firstInstance instanceof org.seasar.struts.action.impl.Test3Action);
