 ...
 * @deprecated changes to <code>ActionFormConfigCreator</code>
 */
public class AutoActionFormRegister {
    ...
    private static boolean registeredFormBeanConfig(StrutsActionFormConfig strutsActionForm, Class formClass,
            ModuleConfig config) {
    ...
    private static String getName(StrutsActionFormConfig form, Class formClass, ModuleConfig config) {
        return StrutsActionFormConfig.DEFAULT_NAME.equals(form.name()) ? rule().getName(formClass, config) : form
                .name();
    }
