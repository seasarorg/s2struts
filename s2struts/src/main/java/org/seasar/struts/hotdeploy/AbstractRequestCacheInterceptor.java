...
public abstract class AbstractRequestCacheInterceptor extends AbstractInterceptor {
    ...
    protected Object invokeAndCache(MethodInvocation invocation, String requestKey, String cacheKey) throws Throwable {
        HttpServletRequest request = S2StrutsContextUtil.getRequest();
        Map cacheMap = (Map) request.getAttribute(requestKey);
        if (cacheMap == null) {
            cacheMap = new HashMap();
            request.setAttribute(requestKey, cacheMap);
        }
