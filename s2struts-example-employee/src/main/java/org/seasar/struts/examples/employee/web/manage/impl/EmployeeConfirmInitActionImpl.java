...
import org.seasar.struts.examples.employee.web.manage.EmployeeConfirmInitAction;
...
public class EmployeeConfirmInitActionImpl implements EmployeeConfirmInitAction {
    ...
    public void initialize() {
        DeptDto dto = this.employeeDxo.convertDeptDto(this.employeeForm);
        dto = this.employeeLogic.getDept(dto);
        this.employeeForm.setDname(dto.getDname());
    }
