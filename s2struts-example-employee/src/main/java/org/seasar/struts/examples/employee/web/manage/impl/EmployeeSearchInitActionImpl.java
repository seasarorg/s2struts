...
import org.seasar.struts.examples.employee.web.manage.EmployeeSearchInitAction;
...
public class EmployeeSearchInitActionImpl implements EmployeeSearchInitAction {
    ...
    private List departmentDtos;

    public List getDepartmentDtos() {
    ...
    public void initialize() {
        this.departmentDtos = this.employeeLogic.getAllDept();
    }
