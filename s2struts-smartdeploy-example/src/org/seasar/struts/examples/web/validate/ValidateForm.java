 ...
 */
package org.seasar.struts.examples.web.validate;
...
import org.seasar.struts.validator.annotation.tiger.ShortType;
...
public class ValidateForm {
    ...
    private String short_ = String.valueOf(Integer.MAX_VALUE);
    ...
    @Args( {
            @Arg(key = "validate.required.other"),
