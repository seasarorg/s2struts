...
public class ClassComparatorTest extends TestCase {
	...
	public void testCompare() {
		...
		assertEquals(StrutsConfigAnnotationAction.class, objects[1]);
		assertEquals(ValidatorAnnotationForm.class, objects[2]);
	...
	public void testSort() {
		...
		assertEquals(StrutsConfigAnnotationAction.class, list.get(1));
		assertEquals(ValidatorAnnotationForm.class, list.get(2));
