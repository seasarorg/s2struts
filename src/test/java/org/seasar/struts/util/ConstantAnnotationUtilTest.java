...
public class ConstantAnnotationUtilTest extends TestCase {
    ...
    /*
     * Test method for
     * 'org.seasar.struts.util.ConstantAnnotationUtil.isConstantAnnotationStringField(Field)'
     */
    public void testIsConstantAnnotationStringField() {
        BeanDesc beanDesc = BeanDescFactory.getBeanDesc(Foo.class);
        assertTrue(ConstantAnnotationUtil
                .isConstantAnnotationStringField(beanDesc
                        .getField("PUBLIC_STATIC_FINAL_STRING")));
        assertFalse(ConstantAnnotationUtil
                .isConstantAnnotationStringField(beanDesc
                        .getField("PUBLIC_STATIC_FINAL_INT")));
        assertFalse(ConstantAnnotationUtil
                .isConstantAnnotationStringField(beanDesc
                        .getField("PUBLIC_STATIC_STRING")));
        assertFalse(ConstantAnnotationUtil
                .isConstantAnnotationStringField(beanDesc
                        .getField("PUBLIC_FINAL_STRING")));
        assertFalse(ConstantAnnotationUtil
                .isConstantAnnotationStringField(beanDesc
                        .getField("PROTECTED_STATIC_FINAL_STRING")));
    }
    ...
    public void testIsConstantAnnotationIntField() {
        ...
        assertTrue(ConstantAnnotationUtil.isConstantAnnotationIntField(beanDesc
                .getField("PUBLIC_STATIC_FINAL_INT")));
        assertFalse(ConstantAnnotationUtil
                .isConstantAnnotationIntField(beanDesc
                        .getField("PUBLIC_STATIC_FINAL_STRING")));
        assertFalse(ConstantAnnotationUtil
                .isConstantAnnotationIntField(beanDesc
                        .getField("PUBLIC_STATIC_INT")));
        assertFalse(ConstantAnnotationUtil
                .isConstantAnnotationIntField(beanDesc
                        .getField("PUBLIC_FINAL_INT")));
        assertFalse(ConstantAnnotationUtil
                .isConstantAnnotationIntField(beanDesc
                        .getField("PROTECTED_STATIC_FINAL_INT")));
    }
