...
public class BindingUtil {
    ...
    private static ActionMapping getPropertyActionMapping(String propertyName, ActionMapping mapping) {
        ...
        //
        // FormBeanÇ…ëŒÇµÇƒï°êîÇÃActionMappingÇ™ìoò^Ç≥ÇÍÇƒÇ¢ÇÈèÍçá
        // Ç∑Ç◊ÇƒÇÃScopeÇ™àÍívÇµÇƒÇ¢ÇΩèÍçáÇÕÅAç≈èâÇÃ1Ç¬ÇÃActionMappingÇï‘ãpÇµ
        // ExportÇ∑ÇÈÇΩÇﬂÇÃèÓïÒÇ∆ÇµÇƒóòópÇ∑ÇÈ
        // ScopeÇ™àŸÇ»ÇÈèÍçáÇÕÅAScopeÇÃê›íËóDêÊèáà ÇÕ request > session Ç∆ÇµÇƒÇ¢ÇÈÇΩÇﬂ
        // requestÉXÉRÅ[ÉvÇÃActionMappingÇóDêÊÇµÇƒï‘ãpÇµ
        // ExportÇ∑ÇÈÇΩÇﬂÇÃèÓïÒÇ∆ÇµÇƒóòópÇ∑ÇÈ
        //
