...
public class AutoActionFormRegister {
    ...
    private static final Logger log = Logger
            .getLogger(AutoActionFormRegister.class);
    ...
    private static void registerFormBeanConfig(ModuleConfig config,
            Class formClass) {
        ...
        formBeanConfig.setRestricted(getRestricted(strutsActionForm, formClass,
                config));
    ...
    private static boolean registeredFormBeanConfig(
            StrutsActionFormConfig strutsActionForm, Class formClass,
            ModuleConfig config) {
    ...
    private static ZeroConfigActionFormRule rule() {
        ...
        return (ZeroConfigActionFormRule) container
                .getComponent(ZeroConfigActionFormRule.class);
    }
    ...
    private static String getName(StrutsActionFormConfig form, Class formClass,
            ModuleConfig config) {
        return StrutsActionFormConfig.DEFAULT_NAME.equals(form.name()) ? rule()
                .getName(formClass, config) : form.name();
    }

    private static boolean getRestricted(StrutsActionFormConfig form,
            Class formClass, ModuleConfig config) {
        return form.restricted() == StrutsActionFormConfig.DEFAULT_RESTRICTED ? rule()
                .getRestricted(formClass, config)
                : form.restricted();
    }
